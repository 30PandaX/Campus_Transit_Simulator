...
To do that:
 ...
 ### Step 2: Getting Project Code
   ...
   #### Setting Up GitHub Account
    ...
    2. In the Sign-up box at the left of the web page:
      ...
      letter. ![P1: GitHub sign up page with example input](./sign_up.png)
    ...
    > you have.
    ![P2: GitHub example main page](./github_main.png)
    ...
    ![P3: GitHub sign-in page](./sign_in.png)
  ...
  executable files at a time.
    ...
    the pop-up window.
    ![P4: Download button](./download_1.png)
 ...
 <hr>
  ...
  #### Launching Terminal and Changing Directory
    ...
    ![P6: Search Terminal](./terminal.png)
  ...
  configuration.
  ![P7: Visualization Simulator Interface](./vis_sim_1.png)
  ...
  6. The Transit Simulator uses the default configuration as below:
    ...
    > for further references.
    >
    ![P8: A Running Vis_sim](./vis_sim_2.png)
